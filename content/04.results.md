...
We reduced the time to compute DWPC over nearly 1200 metepaths from roughly four-and-a-half days to roughly two hours [@url:https://github.com/dhimmel/learn/blob/master/all-features/3-extract.ipynb].
...
![Time to compute the DWPC using the new matrix method](content/images/all_path_time.svg){#fig:all_times}
